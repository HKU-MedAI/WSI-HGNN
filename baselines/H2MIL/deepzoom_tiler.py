...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='WSI', help='Dataset name')
    ...
    parser.add_argument('-s', '--tile_size', type=int, default=512, help='Tile size [224]')
    parser.add_argument('-b', '--base_mag', type=float, default=20, help='Maximum magnification for patch extraction [20]')
    parser.add_argument('-m', '--magnifications', type=int, nargs='+', default=(1,2), help='Levels for patch extraction [0]')
    ...
    path_base = os.path.join('code/data', args.dataset)
    if len(levels) == 2:
        out_base = os.path.join('code/data', args.dataset, 'pyramid')
    else:
        out_base = os.path.join('code/data', args.dataset, 'single')
    ...
    for idx, c_slide in enumerate(all_slides):
        try:
            ...
            print("error for slide id: " + str(idx))
