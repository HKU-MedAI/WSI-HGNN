...
def preparefeatureLabel(batch_graph, batch_label, batch_adjs):
    ...
    # batch_node_feat = torch.zeros(batch_size, max_node_num, 512) # simclr
    batch_node_feat = torch.zeros(batch_size, max_node_num, 1024) # kimianet
...
class Trainer(object):
    ...
    def train(self, sample, model):
        ...
        pred,labels,loss, out = model.forward(node_feat, labels, adjs, masks)
