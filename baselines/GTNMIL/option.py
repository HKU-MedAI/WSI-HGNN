...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--all_normal_set', type=str, help='train')
        parser.add_argument('--all_tumor_set', type=str, help='validation')
        ...
        parser.add_argument('--log_interval_local', type=int, default=2, help='classification classes')
    ...
    def parse(self):
        ...
        args.num_epochs = 150
        args.lr = 1e-3     # COAD: 1e-4; BRCA: 1e-5
