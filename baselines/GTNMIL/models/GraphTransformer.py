...
class Classifier(nn.Module):
    def __init__(self, n_class):
        ...
        # self.conv1 = GCNBlock(512,self.embed_dim,self.bn,self.add_self,self.normalize_embedding,0.,0)       # 64->128 (simclr)
        self.conv1 = GCNBlock(1024,self.embed_dim,self.bn,self.add_self,self.normalize_embedding,0.,0)       # 64->128 (kimianet)
