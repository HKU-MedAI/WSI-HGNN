...
class KimiaSimCLR(object):
    ...
    def train(self):
        ...
        model = fully_connected(model.features, num_ftrs, 512)
        ###############################
...
#                                                                last_epoch=-1)
        ...
        for epoch_counter in range(self.config['epochs']):
            ...
            if epoch_counter % self.config['eval_every_n_epochs'] == 0:
                ...
                if valid_loss < best_valid_loss:
                    ...
                    torch.save(model.state_dict(), os.path.join(model_checkpoints_folder, 'COAD_model_v3.pth'))
                    print('saved')
    ...
    def _load_pre_trained_weights(self, model):
        try:
            ...
            state_dict = torch.load(os.path.join(checkpoints_folder, 'KimiaNetPyTorchWeights.pth'))
