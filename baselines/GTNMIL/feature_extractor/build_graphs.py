...
def compute_feats(args, bags_list, i_classifier, save_path=None, whole_slide_path=None):
    ...
    for i in range(0, num_bags):
        ...
        if  args.magnification == '20x':
            ...
            file_name = bags_list[i].split('/')[-1].split('_files')[0]
            # file_name = bags_list[i].split('/')[-1].split('.')[0]
        ...
        try:
            ...
            print(f"Failed for bags id: {file_name}")
...
def main():
    ...
    # model = ResNetSimCLR('resnet18', 512)
    # num_ftrs = model.l2.in_features
    # model.l2 = nn.Linear(num_ftrs, 2)
    ...
    model.load_state_dict(torch.load('../data/weights/KimiaNetPyTorchWeights.pth'))
    ###############################################################################

    os.makedirs(args.output, exist_ok=True)
    bags_list = glob.glob(args.dataset)
    # compute_feats(args, bags_list, i_classifier, args.output)
    compute_feats(args, bags_list, model, args.output)
    
if __name__ == '__main__':
    main()


# BRCA pretrained path: "runs/Sep02_10-44-35/checkpoints/BRCA_model.pth"
#      patches path: "../data/gtnmil_data/patches/BRCA/*files"
#      output path: "../data/gtnmil_data/graphs/BRCA_graphs"

# COAD pretrained path: "runs/Sep05_01-18-06/checkpoints/COAD_model.pth"
#      patches path: "../data/gtnmil_data/patches/COAD/*files"
#      output path: "../data/gtnmil_data/graphs/COAD_graphs"

# ESCA pretrained path: "runs/Sep12_16-16-35/checkpoints/ESCA_model.pth"
#      patches path: "../data/gtnmil_data/patches/ESCA/*files"
#      output path: "../data/gtnmil_data/graphs/ESCA_graphs"